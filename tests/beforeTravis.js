...
function copyOdmModule() {
  return new Promise(function(resolve, reject) {
    var pkgJson     = path.join(__dirname, '../', prName, 'package.json')
      , fromDir     = path.join(__dirname, '../')
      , toDir       = path.join(__dirname, '../', prName, 'modules', 'clever-odm');

    console.log('step #2 - copy clever-odm module in test project - begin\n');
